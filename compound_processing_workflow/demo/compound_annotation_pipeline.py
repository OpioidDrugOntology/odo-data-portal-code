#!/usr/bin/env python3
"""
Combined SMILES annotation pipeline with CSV input and Excel output.
...
# -----------------------------------------------------------------------------
INPUT_FILE = Path("smiles_input_file.csv")
OUTPUT_FILE = Path("compound_processing_output.xlsx")
...
def save_checkpoint(df: pd.DataFrame, path: Path) -> None:
    """Save a restart-friendly Excel file in the final output schema."""
